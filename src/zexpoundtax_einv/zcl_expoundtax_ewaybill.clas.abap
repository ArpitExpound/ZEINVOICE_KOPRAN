  ...
  METHOD cancel_eway.
    ...
    IF sy-subrc = 0.
      ...
      IF sy-subrc = 0.
        ...
        SELECT SINGLE * FROM zei_api_url WHERE method = 'CAN_EWB' AND param1 = @lv_gstin INTO @DATA(ls_api_url).
        IF sy-subrc = 0.
  ...
  METHOD create_eway_with_irn.
    ...
    IF sy-subrc = 0.
      ...
      IF sy-subrc = 0.
        ...
        CLEAR : gv_gstin, gv_username, gv_token.
        SELECT SINGLE * FROM zei_api_url WHERE method = 'GEN_EWB' AND param1 = @lv_gstin INTO @DATA(ls_api_url).
        IF sy-subrc = 0.
          gv_gstin    = ls_api_url-param1.
          gv_username = ls_api_url-param2.
          gv_token    = |Token { ls_api_url-param3 }|.
